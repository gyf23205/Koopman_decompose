...
if __name__=='__main__':
    ...
    trainloader = mnist.train_loader
    mnist_per_class = MNISTPerClass(batch_size)
    train_loader_per_class = [mnist_per_class.sub_trainloaders[i] for i in idx_class_train]
    optims = []
